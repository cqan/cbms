     ...
     <script type="text/javascript" src="${ctx}resources/js/system.js"> </script>
  	...
  	<body class="easyui-layout" style="overflow-y: hidden"  fit="true"   scroll="no">
	    ...
	    <div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
	        ...
	        <span style="float:right; padding-right:20px;" class="head">欢迎 <%=SecurityUtils.getSubject().getPrincipal()%> <a href="#" id="editpass">修改密码</a> <a href="#" id="loginOut">安全退出</a></span>
	        <span style="padding-left:10px; font-size: 16px; "><img src="${ctx}resources/images/blocks.gif" width="20" height="20" align="absmiddle" /> 北京联通校园网运营管理平台系统</span>
	    </div>
